...
echo -e "$GREEN**************************************************$COL_RESET"
echo -e "$GREEN* CyberCore Install Script v2.1 For Ubuntu 20.04 *$COL_RESET"
echo -e "$GREEN* Installing And Setup FireAnts Wallet            *$COL_RESET"
echo -e "$GREEN**************************************************$COL_RESET"
echo
sleep 3
...
mkdir -p fireants
cd fireants
hide_output wget https://github.com/hgr3dsm/Fireants-Source/releases/download/v1.1.0/fireants_x86_64-pc-linux-gnu_v1.1.0.tar.gz
hide_output tar -xvf fireants_x86_64-pc-linux-gnu_v1.1.0.tar.gz
rm -rf fireants_x86_64-pc-linux-gnu_v1.1.0.tar.gz
hide_output sudo install -m 0755 -o root -g root -t /usr/bin *
hide_output sudo install -m 0755 -o root -g root -t /usr/local/bin *
cd ~
hide_output rm -rf fireants
mkdir -p .fireants
sleep 2
echo -e "$GREEN=> Done...$COL_RESET"
...
echo
echo
echo -e "$CYAN=> Generating Fireants Wallet Config File...$COL_RESET"
echo
sleep 3
...
rpcbind=0.0.0.0
' | sudo -E tee $HOME/.fireants/fireants.conf >/dev/null 2>&1
sleep 2
echo -e "$GREEN=> Done...$COL_RESET"
...
hide_output fireantsd -shrinkdebugfile
sleep 5
echo -e "$GREEN=> Done...$COL_RESET"
...
wallet="$(fireants-cli getnewaddress "")"
sleep 2
echo -e "$GREEN=> Done...$COL_RESET"
...
echo
echo
echo -e "$CYAN=> Creating Credentials File For Fireants..$COL_RESET"
echo
sleep 3
...
echo
echo
echo -e "$CYAN=> Creating Pool Config File For Fireants...$COL_RESET"
echo
sleep 3
